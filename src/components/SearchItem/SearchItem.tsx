      ...
      <div className={styles.SearchItem__content_wrapper}>
        <span className={styles.SearchItem__price_wrapper}>
          <span className={styles.SearchItem__price}>
            {/* {item.price.currency} */}
             $ {item.price.amount}<small className={styles.SearchItem__price_decimals}>{item.price.decimals}</small>
          </span>
          {item.free_shipping ? (
            <img
        ...
        <div className={styles.SearchItem__location_wrapper}>
          <span className={styles.SearchItem__location}>{item.address.state}</span>
        </div>

        <h2 className={styles.SearchItem__title}>
          {item.title}
        </h2>
      </div>
    </div>
